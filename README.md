...
`Инструмент: normalizer|checker|syncher`, `Режим: production|dry-run` и строками тела:
...
и в `production`, и в `dry-run`; во втором случае фиксируется план без применения.
