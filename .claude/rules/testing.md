...
> Claude-эквивалент [`.cursor/rules/testing.mdc`](../../.cursor/rules/testing.mdc). Применяется всегда.
...
`test_log.py` (+ `rules/test_<rule>.py`, `test_runner.py`); checker — `test_engine.py`,
