"""Веб-хук об итогах синхронизации (fire-and-forget).

Конфигурация — из .env рядом со скриптом (FSSYNC_WEBHOOK_URL / FSSYNC_WEBHOOK_TOK)
...
# .env лежит рядом со скриптом (корень проекта = родитель пакета syncher/), а не в
# синхронизируемом каталоге: путь фиксирован, т.к. cron/таймер стартует из любого cwd.
_ENV_PATH = Path(__file__).resolve().parents[1] / ".env"

_URL_KEY = "FSSYNC_WEBHOOK_URL"
_TOK_KEY = "FSSYNC_WEBHOOK_TOK"
